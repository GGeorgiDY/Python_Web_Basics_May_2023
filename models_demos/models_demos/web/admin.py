...
# тук създавайки класове, ще можем да ги видим в Admin панела на суперюзъра
...
class EmployeeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Professional Info', {'fields': ('level', 'years_of_experience')}),
        ('Company Info', {'fields': ('department', 'is_full_time', 'start_date')}),
    )
